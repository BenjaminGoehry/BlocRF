...
n <- 1200
# DataSim <- mlbench.friedman1(n, sd=1)
# model <- list(ar = 0.5)
# DataSim <- mlbench.friedman1_cor (n, sd = 1, model=model) 
...
saveRDS(res, file="Results/mlbench.friedman1/AR_05.RDS")


col <- piratepal("basel")
plot(block.size, mse_rf_mb, type='l', ylim=range(mse_rf_iid, mse_rf_mb, mse_rf_cir), col=col[1])
